									...
									<div class="col-md-6 mb-4 pb-2">
										...
										<div class="form-outline">
												<label for="firstName>">First Name:</label><br> <input type="text"
													name="firstName" value="${loggedInUser.firstName }" required>
											</div>
								...
								<div class="row">
									<div class="col-md-6 mb-4 pb-2">
										...
										<div class="form-outline">
												...
												name="lastName" value="${loggedInUser.lastName }" required>
								...
								<div class="row">
									<div class="col-md-6 mb-4 pb-2">
										...
										<div class="form-outline">
													...
													<input type="text" name="password" value="${loggedInUser.password }" required>
												</div>
