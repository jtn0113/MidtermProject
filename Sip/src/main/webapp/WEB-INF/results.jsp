...
<body>
<%-- <c:forEach var="beerTasting" items="${beerResults }">
	${beerTasting }
	<br>
</c:forEach> --%>
...
<div id="beer">
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="headingOne${beerTasting}EmptyBeer">
					<button class="accordion-button" type="button"
						...
						<c:if test="${empty beerResults }">Hmm. Looks empty!
							</c:if>
					</button>
				</h2>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="headingOne${wineTasting}EmptyWine">
					<button class="accordion-button" type="button"
						...
						<c:if test="${empty wineResults }">Hmm. Looks empty!<br>
							</c:if>
					</button>
				</h2>
	...
	<c:forEach var="wineTasting" items="${wineResults }">
		<div class="accordion" id="accordionExample">
			<div class="accordion-item">
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="headingOne${spiritTasting}EmptySpirit">
					<button class="accordion-button" type="button"
						...
						<c:if test="${empty spiritResults }">Hmm. Looks empty!
							</c:if>
					</button>
				</h2>
	...
	<c:forEach var="spiritTasting" items="${spiritResults }">
		<div class="accordion" id="accordionExample">
			<div class="accordion-item">
